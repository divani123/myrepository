				...
				<div class="contact-caption clearfix">
					...
					<form class="form" action="connect.php" method="post" enctype="multipart/form-data" style="padding-left: 240px">
						...
						<div class="col-md-7 col-md-offset-1 contact-form">
							...
							<br>
								<input type="submit" name="delete" value="DELETE" style="font-family: Georgia; font-size: 18px; width:180px; height: 50px; background-color:blue">
								<a href="delete.php"><input value="CLEAR" style="text-align: center; font-family: Georgia; font-size: 18px; width:145px; height: 50px"></a>
