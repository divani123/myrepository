...
$Image = $_FILES['image']['name'];
	...
	if(isset($_POST['enter'])){
	mysqli_query($db, "INSERT INTO doctor (id,name,category,email,date,time,image) VALUES('$ID','$Name','$Category','$Email','$Date','$Time','$Image')");
	}
	...
	if(isset($_POST['edit'])){
		mysqli_query($db, "UPDATE doctor SET id = '$ID', name ='$Name', category = '$Category', email = '$Email', date = '$Date', time = '$Time', image = '$Image' WHERE id = '$ID'");
	}
		...
		<div class="container">
			<div class="row">
				<h2>
					...
					if(isset($_POST['enter'])){
						echo "succefully record added";
					}
					if (isset($_POST['edit'])) {
						echo "succefully record edited";
					}
					if (isset($_POST['delete'])) {
						echo "succefully record deleted";
					}
