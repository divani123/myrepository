...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">HEALTH<span>CARE</span></a>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/bg-11.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> Prevention is Better Than Cure</h1>
              <p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Good health is a process which enhances your physical well-being enabling you to engage in Social, Mental, and Spiritual aspects of life. It is a luxury - we guarantee this to all our Clients. </p>
      ...
      <div class="slider-item" style="background-image: url('images/650x350_pediatrician_or_family_practitioner_ref_guide.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern Achieve Your Desired Perfect Smile</h1>
              <p class="mb-4">Dear patient! A successful treatment requires a relaxed and trustful atmosphere in the practice.</p>
   ...
   <!-- <section class="ftco-section ftco-services">
      ...
      <div class="container-wrap mt-5">
      	<div class="row d-flex no-gutters">
      		<div class="col-md-6 img" style="background-image: url(images/health-care-.jpg);">
      		</div>
      		<div class="col-md-6 d-flex">
      			<div class="about-wrap">
      				<div class="heading-section heading-section-white mb-5 ftco-animate">
		            <h2 class="mb-2">HEALTH CARE with a personal touch</h2>
		            <p>Good health is a process which enhances your physical well-being enabling you to engage in Social, Mental, and Spiritual aspects of life. It is a luxury - we guarantee this to all our Clients.</p>
		          </div>
      				...
      				<div class="list-services d-flex ftco-animate">
      					...
      					<div class="text">
	      					...
	      					<p>Give special and personalised attention a world-class service in a dedicated area. Tests are conducted in comfortable surroundings by caring staff, using the cutting edge technology to produce accurate and fast results.</p>
      					</div>
      				</div>
      				<div class="list-services d-flex ftco-animate">
      					<div class="icon d-flex justify-content-center align-items-center">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">
    	<div class="container">
    		<div class="row d-flex align-items-center">
	            ...
	            <p>HEALTH CARE Hospital aims to deliver the very best health care in a safe, compassionate environment.</p>
	          </div>
    			</div>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
              ...
              <p>You can now Subscribe our system..!</p>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text d-flex py-4">
                ...
                <div class="desc pl-3">
	                <h3 class="heading">I would like to offer my gratitude and heartfelt thanks to the staff at HEALTH CARE Hospital for helping my mother in her time of need.</h3>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              ...
              <div class="text d-flex py-4">
                ...
                <div class="desc pl-3">
	                <h3 class="heading">Thank you very much for your time, correct diagnosis, that let me get back to health. Please convey thanks to the manager and staff of the hospital.</h3>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="200">
              ...
              <div class="text d-flex py-4">
                ...
                <div class="desc pl-3">
	                <h3 class="heading">The services and treatment provided to me at the time of my admission to HEALTH CARE hospital on 23rd November was admirable.</h3>
	              </div>
              </div>
            </div>
          </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 pr-md-5 aside-stretch py-5 choose">
    				<div class="heading-section heading-section-white mb-5 ftco-animate">
	            <h2 class="mb-2">HEALTH CARE Procedure &amp; High Quality Services</h2>
	          </div>
	          <div class="ftco-animate">
	          	<p>When it comes to choosing a hospital, one thing is clear: quality counts. With more than five years of tradition, excellence and quality in providing medical care in a comfortable and convenient environment, we bring peace of mind for the thousands of patients we care about every day with the help of our doctors, specialists and nurses.</p>
	          	<ul class="un-styled my-5">
	          		<li><span class="icon-check"></span>Our main ambition is your bright and relaxed smile</li>
	          		<li><span class="icon-check"></span>We make you feel at home</li>
	          		<li><span class="icon-check"></span>One place to your all healthcare needs</li>
	          	</ul>
	          </div>
    			</div>
        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">HEALTH CARE.</h2>
              <p>We are your total healthcare provider and that means you can reach out to us when you are ill or hurt...</p>
            </div>
          ...
          <div class="col-md-4 pr-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="blog-single.html">Thank you very much for your time, correct diagnosis, that let me get back to health. Please convey thanks to the manager and staff of the hospital.</a></h3>
                  <div class="meta">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading" ><a href="blog-single.html">I would like to offer my gratitude and heartfelt thanks to the staff at HEALTH CARE Hospital for helping my mother in her time of need.</a></h3>
                  <div class="meta">
                    <div><span class="icon-calendar"></span> Sept 15, 2018</div>
                    <div><span class="icon-person"></span> Admin</div>
                    <div><span class="icon-chat"></span> 19</div>
          ...
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">HEALTH CARE Hospital, No.104, Colombo, Sri Lanka.</span></li>
	                <li><span class="icon icon-phone"></span><span class="text">+2 392 3929 210</span></li>
	                <li><span class="icon icon-envelope"></span><span class="text">info@healthcare.com</span></li>
	              </ul>
	            </div>
            </div>
          </div>
